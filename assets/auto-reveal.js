...
const EXCLUDE_SELECTOR =
  '.section-background, .custom-section-background, script, style, .sticky-add-to-cart, .menu-drawer, .menu-drawer__submenu, .mega-menu, .facets, .facets-block-wrapper, dialog, dialog-component, .background-overlay, .header__underlay, .collection-wrapper, .main-collection-grid, .product-grid, .product-grid__item, .product-information__grid, .product-details';
